...
class ViewerBot:
    def print_exception(self):
        ...
        print('Исключение в ({}, на линии {} "{}"): {}'.format(filename, lineno, line.strip(), exc_obj))
    ...
    def get_proxies(self):
        ...
        try:
            ...
            print("Ошибка связана с файлом с прокси: %s" % e.strerror)
            sys.exit(1)
        ...
        try:
            ...
            try:
                 if time.time() - proxy_data['time'] >= random.randint(1, 5):
                    ...
                    print(f"Отправлен запрос с {current_proxy['http']} | {response.status_code} | {response.request} | {response}")
